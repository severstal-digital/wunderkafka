...
from wunderkafka.serdes.avromodel.pydantic import derive_from_pydantic, exclude_pydantic_key
...
def derive(model_type: Type[object], topic: str, *, is_key: bool = False) -> str:
    ...
    if pydantic_model:
        ...
        for key in ['pydantic-class', 'doc']:
            model_schema = exclude_pydantic_key(model_schema, key)
